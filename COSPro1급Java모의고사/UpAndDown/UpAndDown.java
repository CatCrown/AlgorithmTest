package COSPro1급Java모의고사.UpAndDown;
...
class Solution {
    ...
    public static void main(String[] args) {
        ...
        int K4 = 10;
        int[] numbers4 = {2,3,9,8};
        String[] UpDown4 = {new String("UP"), new String("UP"), new String("DOWN"),new String("DOWN")};
        int ret4 = sol.solution(K4, numbers4, UpDown4);
